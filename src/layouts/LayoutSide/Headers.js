                        ...
                        <div className="row">
                            <div className="col">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-3">
                                        <div className="fs-2 text-info"><FaPhone /></div>
                                    </div>
                                   
                                   
                                    <div className="col-9">
                                        Tư vấn hỗ trợ<br /> 
                                        <strong className="text-info">0349544297</strong>
                                    </div>
                                </div>
                            </div>
                            <div className="col">
                                <div className="row">
                                    <div className="col-3">
                                        <div className="fs-2 text-info"><FaUserTie/></div>

                                    </div>
                                    <div className="col-9">
                                        Xin chào<br />
                                       <Link style={{textDecorationLine:"none"}} to="/Login"> <strong className="text-info">Đăng nhập</strong></Link>
                                    </div>
                                </div>
                            </div>
                        </div>
