        ...
        <div className="col-md-3 mb-3" >
            <div className="product-item border">
                ...
                <div className="product-pice p-2">
                    <div className="row">
                        <div className="col-6">
                            <strong className="text-info fs-3">{props.product.pricesale}<sup>$</sup></strong>
                        </div>
            ...
            <div className="link-detail p-2">
                <Link className="nav-link text-info active" to={`/chi-tiet-san-pham/${props.product.slug}`}>Chi tiết sản phẩm</Link>
            </div>
        </div>
    );
}
